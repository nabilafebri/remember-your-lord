...
import id.ac.ui.cs.mobileprogramming.nabila_febri_viola.remember_your_lord.model.Activity.DummyItem;
...
public class MyActivityRecyclerViewAdapter extends RecyclerView.Adapter<MyActivityRecyclerViewAdapter.ViewHolder> {
    ...
    public MyActivityRecyclerViewAdapter(List<DummyItem> items) {
        mValues = items;
    }
